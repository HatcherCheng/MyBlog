...
<div class="wrapper">
    ...
    <header class="main-header">
        <a href="${base}/index" class="logo">
            ...
            <span class="logo-lg"><b>HC</b>BLOG</span>
        </a>
...
<#macro pagerlist url p spans channelId title>
    <#local span = (spans - 3)/2 />
    <#local pageNo = p.number + 1 />
    <#local cURL = (url +"?channelId="+channelId+"&title="+title+"&pageNo=") />
...
<#macro pagername url p spans name>
    <#local span = (spans - 3)/2 />
    <#local pageNo = p.number + 1 />
    <#local cURL = (url +"?name="+name+"&pageNo=") />
...
<#macro pagerrole url p spans name>
    <#local span = (spans - 3)/2 />
    <#local pageNo = p.number + 1 />
    <#local cURL = (url +"?name="+name+"&pageNo=") />
